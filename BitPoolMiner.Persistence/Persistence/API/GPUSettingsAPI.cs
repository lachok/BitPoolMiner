...
namespace BitPoolMiner.Persistence.API
{
    ...
    /// </summary>
    public class GPUSettingsAPI : APIBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ObservableCollection<GPUSettings> GetGPUSettings(string accountId, string workerName)
        {
            string apiURL = "";
            try
            {
                ...
                nameValueCollection.Add("WorkerName", workerName);
