...
namespace BitPoolMiner.Persistence.API
{
    ...
    /// </summary>
    public class AccountWalletAPI : APIBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<AccountWallet> GetAccountWalletList(string accountId)
        {
            ...
            try
            {
                ...
                accountWalletList = accountWalletList.Select(c => { c.AccountGuid = Guid.Parse(accountId); return c; }).ToList();
            ...
            {
                logger.Error(e, $"Unable to retrieve the account wallet list for '{accountId}' from '{apiURL}'");
