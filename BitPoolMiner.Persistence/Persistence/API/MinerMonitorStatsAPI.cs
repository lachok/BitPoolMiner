...
namespace BitPoolMiner.Persistence.API
{
    ...
    /// </summary>
    public class MinerMonitorStatsAPI : APIBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ObservableCollection<MinerMonitorStat> GetMinerMonitorStats(string accountId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ObservableCollection<MinerMonitorStat> GetMinerMonitorStats24Hour(string accountId)
        {
